            ...
            <View className="flex-1 -mt-2">
                ...
                <View className="flex-1 items-center justify-center px-4">
                    ...
                    <View className="items-center mb-4">
                        ...
                        <AppText styles="text-base text-slate-700 text-center leading-relaxed px-4">
                    ...
                    <View className="">
                        ...
                        >
                            <View className="flex-row items-center gap-2">
                                ...
                                <AppText styles="text-base text-white font-nunbold">Sign In</AppText>
                            </View>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View className="flex-row items-center w-full my-4">
                        ...
                        <AppText styles="text-sm text-slate-600 mx-4">OR</AppText>
                        <View className="flex-1 h-px bg-slate-600" />
                    </View>
                        ...
                        <View className="gap-3">
                            {[
                                ...
                                <View key={index} className="flex-row items-center gap-3">
                                    ...
                                    <AppText styles="text-sm text-slate-700">{feature.text}</AppText>
                                </View>
                            ))}
                        </View>
                    </View>
