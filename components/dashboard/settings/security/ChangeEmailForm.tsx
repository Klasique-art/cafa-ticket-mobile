                    ...
                    <View className="gap-4">
                        ...
                        <View className="p-3 rounded-lg border" style={{ backgroundColor: colors.primary200 + "80", borderColor: colors.accent + "4D" }}>
                            <View className="flex-row items-start gap-2">
                                ...
                                <AppText styles="text-xs text-white" font="font-iregular" style={{ opacity: 0.7, flex: 1 }}>
                ...
                <View className="gap-4">
                    <View className="p-4 rounded-lg border" style={{ backgroundColor: colors.accent + "1A", borderColor: colors.accent }}>
                        <View className="flex-row items-start gap-3">
                            ...
                            <View className="flex-1">
                                <AppText styles="text-sm text-white mb-2" font="font-ibold" style={{ color: colors.accent50 }}>
                                    Verification Link Sent!
                                </AppText>
                                <AppText styles="text-xs text-white" font="font-iregular" style={{ opacity: 0.8 }}>
                                    We've sent a verification link to <AppText font="font-ibold">{maskedEmail}</AppText>. Please
