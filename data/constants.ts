export const APP_DOMAIN_NAME = "https://cafatickets.com";
export const APP_NAME = "Cafa Tickets";
export const APP_EMAIL = "support@cafatickets.com";
export const APP_NUMBER = "+1 (904) 422-8963";
